...
$(document).ready(function () {
   ...
   var table= $('#table_biodegs').DataTable({
        "ajax": {
            "url": "/api/biodegs",
            "type": "Post",
            data: function (data) {
 ...
 <div class="dropdown">
  ...
  <div class="dropdown-content">
          ...
          <a class="dropdown-item" href="biodegs/edit/${row.id}">
            ${Buttons.edit}</a>
        ...
        buttons: [
          ...
          
            {
                ...
                className: "page-lenght-list",
                action: function (e, dt, button, config) {
                    window.location.href = '/biodegs/create';
                }
            },
    ...
    $(document).on('click', '.deleteButton', function (e) {
        ...
        showConfirmMessage(AlertMessages.delete_biodeg_confirm_msg)
            .then(result => {
                if (result.isConfirmed) {
                    $.ajax({
                        url: '/biodegs/delete/' + rowId,
                        type: 'POST',
