...
$(document).ready(function () {
   ...
   var table= $('#table_artifacttypes').DataTable({
        "ajax": {
            "url": "/api/artifacttypes",
            "type": "Post",
            data: function (data) {
 ...
 <div class="dropdown">
  ...
  <div class="dropdown-content">
          ...
          <a class="dropdown-item" href="artifacttypes/edit/${row.id}">
            ${Buttons.edit}</a>
        ...
        buttons: [
            ...
            },
            {
                ...
                action: function (e, dt, button, config) {
                    ...
                    form.method = 'POST';
                    form.action = '/artifacttypes/export';
            ...
            },
            {
                ...
                className: "page-lenght-list",
                action: function (e, dt, button, config) {
                    window.location.href = '/artifacttypes/create';
                }
            },
    ...
    $(document).on('click', '.deleteButton', function (e) {
        ...
        showConfirmMessage(AlertMessages.delete_artifacttype_confirm_msg)
            .then(result => {
                if (result.isConfirmed) {
                    $.ajax({
                        url: '/artifacttypes/delete/' + rowId,
                        type: 'POST',
