  ...
  var table =  $('#tb_artifacts').DataTable({
      ...
      stateSave: false,
        ...
        buttons: [
            {
                extend: "excelHtml5",
                text: ' <i class="mdi mdi-export excel-icon" > </i>',
                title: function () {
            ...
            {
                extend: "print",
                text: '<i class="mdi mdi-cloud-print-outline print-icon"></i>',
                exportOptions: {
                    columns: ':visible:not(.actions)'
                },
      ...
      <div class=" text-dark text-center mb-2"><br>بسم الله الرحمن الرحيم</div>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-4 text-dark text-center "><br>${Report.no} : ${$('#exportNumber').val()}<br>${Report.data} : ${$('#exportDate').val()} </div>
