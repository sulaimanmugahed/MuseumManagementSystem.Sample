...
$(document).ready(function () {
  ...
  var table=  $('#table_timeperiods').DataTable({
        "ajax": {
            "url": "/api/timeperiods",
            "type": "Post",
            data: function (data) {
 ...
 <div class="dropdown">
  ...
  <div class="dropdown-content">
          ...
          <a class="dropdown-item" href="timeperiods/edit/${row.id}">
            ${Buttons.edit}</a>
        ...
        buttons: [
            ...
            },
            {
                ...
                action: function (e, dt, button, config) {
                    ...
                    form.method = 'POST';
                    form.action = '/timeperiods/export';
            ...
            },
            {
                ...
                className: "page-lenght-list",
                action: function (e, dt, button, config) {
                    window.location.href = '/timeperiods/create';
                }
            },
    ...
    $(document).on('click', '.deleteButton', function (e) {
        ...
        showConfirmMessage(AlertMessages.delete_timeperiod_confirm_msg)
            .then(result => {
                if (result.isConfirmed) {
                    $.ajax({
                        url: '/timeperiods/delete/' + rowId,
                        type: 'POST',
