const AlertText = {
    confirmQ: "Êtes-vous sûr ?",
    cancel: "Annuler",
    ok: "OK",
    yes: "Oui",
    successtitle: "Opération réussie",
    dangertitle: "Une erreur s'est produite !",
};
...
const AlertMessages = {
    "delete_artifact_confirm_msg": "Êtes-vous sûr de vouloir supprimer cet artefact ?",
    "delete_safe_confirm_msg": "Êtes-vous sûr de vouloir supprimer ce coffre-fort ?",
    "delete_stowage_confirm_msg": "Êtes-vous sûr de vouloir supprimer cet entrepôt ?",
    "delete_material_confirm_msg": "Êtes-vous sûr de vouloir supprimer ce matériau ?",
    "delete_artifacttype_confirm_msg": "Êtes-vous sûr de vouloir supprimer ce type d'artefact ?",
    "delete_artifactcondition_confirm_msg": "Êtes-vous sûr de vouloir supprimer cet état d'artefact ?",
    "delete_biodeg_confirm_msg": "Êtes-vous sûr de vouloir supprimer cette biodégradabilité ?",
    "delete_timeperiod_confirm_msg": "Êtes-vous sûr de vouloir supprimer cette période ?",
    "delete_user_confirm_msg": "Êtes-vous sûr de vouloir supprimer cet utilisateur ?",
    "clear_recyclebin_confirm_msg": "Êtes-vous sûr de vouloir vider complètement la corbeille ?",
    "recovery_artifact_confirm_msg": "Êtes-vous sûr de vouloir restaurer cet artefact ?",
    "kill_artifact_confirm_msg": "Vous ne pourrez pas restaurer cet artefact après cette opération",
    should_choose_image_msg: "Vous devez d'abord choisir une image",
...
const Buttons = {
    ...
    manageSafes: "Gérer les coffres-forts",
    clear: "Vider"
};
