const AlertMessages = {
    delete_artifact_confirm_msg: "Вы уверены, что хотите удалить этот артефакт?",
    delete_safe_confirm_msg: "Вы уверены, что хотите удалить этот сейф?",
    delete_stowage_confirm_msg: "Вы уверены, что хотите удалить это хранилище?",
    delete_material_confirm_msg: "Вы уверены, что хотите удалить этот материал?",
    delete_artifacttype_confirm_msg: "Вы уверены, что хотите удалить этот тип артефакта?",
    delete_artifactcondition_confirm_msg: "Вы уверены, что хотите удалить это состояние артефакта?",
    delete_biodeg_confirm_msg: "Вы уверены, что хотите удалить эту биоразлагаемость?",
    delete_timeperiod_confirm_msg: "Вы уверены, что хотите удалить эту эпоху?",
    delete_user_confirm_msg: "Вы уверены, что хотите удалить этого пользователя?",

    clear_recyclebin_confirm_msg: "Вы уверены, что хотите очистить корзину полностью?",
    recovery_artifact_confirm_msg: "Вы уверены, что хотите восстановить этот артефакт?",
    kill_artifact_confirm_msg: "Вы не сможете восстановить этот артефакт после этой операции",

    should_choose_image_msg: "Вы должны сначала выбрать изображение",
