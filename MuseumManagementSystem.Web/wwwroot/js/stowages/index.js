...
$(document).ready(function () {
   ...
   var table= $('#table_safes').DataTable({
        ...
        "columns": [
            ...
            { "data": "safesCount", "name": "SafesCount", "autowidth": true },
 ...
 <div class="dropdown">
  ...
  <div class="dropdown-content">
          ...
          <a class="dropdown-item" href="stowages/managesafes/${row.id}">
            ${Buttons.manageSafes}</a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="stowages/showartifacts/${row.id}">
          ${Buttons.showArtifacts}</a>
          <div class="dropdown-divider"></div>

          <a class="dropdown-item" href="stowages/edit/${row.id}">
            ${Buttons.edit}</a>
            <div class="dropdown-divider"></div>
        ...
        buttons: [
            ...
            },
            {
                ...
                action: function (e, dt, button, config) {
                    window.location.href = '/stowages/create';
                }
            }
    ...
    $(document).on('click', '.deleteButton', function (e) {
        ...
        showConfirmMessage(AlertMessages.delete_stowage_confirm_msg)
            .then(result => {
                if (result.isConfirmed) {
                    $.ajax({
                        url: '/stowages/delete/' + rowId,
                        type: 'POST',
