...
$(document).ready(function () {
   ...
   var table= $('#table_artifactconditions').DataTable({
        "ajax": {
            "url": "/api/artifactconditions",
            "type": "Post",
            data: function (data) {
 ...
 <div class="dropdown">
  ...
  <div class="dropdown-content">
          ...
          <a class="dropdown-item" href="artifactconditions/edit/${row.id}">
            ${Buttons.edit}</a>
        ...
        buttons: [
            ...
            },
            {
                ...
                action: function (e, dt, button, config) {
                    ...
                    form.method = 'POST';
                    form.action = '/artifactconditions/export';
          ...
          
            {
                ...
                className: "page-lenght-list",
                action: function (e, dt, button, config) {
                    window.location.href = '/artifactconditions/create';
                }
            },
    ...
    $(document).on('click', '.deleteButton', function (e) {
        ...
        showConfirmMessage(AlertMessages.delete_artifactcondition_confirm_msg)
            .then(result => {
                if (result.isConfirmed) {
                    $.ajax({
                        url: '/artifactconditions/delete/' + rowId,
                        type: 'POST',
