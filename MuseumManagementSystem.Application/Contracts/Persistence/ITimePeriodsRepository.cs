...
{
    public interface ITimePeriodsRepository : IGenericRepository<TimePeriod>
    {
        ...
        Task<PagedResult<TimePeriod>> GetAllTimePeriodsPagedAsync(string? searchValue, int? start, int? length, string? sortColumn = null, string? sortDirection = "ASC");
    }
}
